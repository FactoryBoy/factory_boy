...
class MaybeTestCase(unittest.TestCase):
    ...
    def test_declarations(self):
        ...
        self.assertEqual(
            dict(a=1, b=2, biggest='b', max_value=2),
            obj_ordered.as_dict,
        )
        self.assertEqual(
            dict(a=3, b=3, biggest='a', max_value=3),
            obj_equal.as_dict,
        )
        self.assertEqual(
            dict(a=5, b=4, biggest='a', max_value=5),
            obj_reverse.as_dict,
        )
...
class SubFactoryTestCase(unittest.TestCase):
    ...
    def test_nonstrict_container_attribute(self):
        ...
        class TestModelFactory(FakeModelFactory):
            ...
            one = 3
            two = factory.ContainerAttribute(
                lambda obj, containers: len(containers or []),
                strict=False,
            )
    ...
    def test_strict_container_attribute(self):
        ...
        class TestModelFactory(FakeModelFactory):
            ...
            sample_int = 3
            container_len = factory.ContainerAttribute(
                lambda obj, containers: len(containers or []),
                strict=True,
            )
...
class RelatedListFactoryTestCase(unittest.TestCase):
    def test_related_factory_list_of_varying_size(self):
        ...
        class TestObjectFactory(factory.Factory):
            ...
            three = factory.RelatedFactoryList(
                TestRelatedObjectFactoryList,
                'obj',
...
class ListTestCase(unittest.TestCase):
    ...
    def test_list_merged_fields(self):
        class TestObjectFactory(factory.Factory):
            ...
            two = 13
            one = factory.List([1, 2, factory.SelfAttribute('1')])
